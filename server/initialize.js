...
export default async (models) => {
    ...
    const eventList = [
        ...
        },
        {
            ...
            poiId: poi7.id,
            accessInfo: ["done", "block", "block"],
            timeInfo: ["The 23/7 from 9:00pm to 00:00am"],
        ...
        },
        {
            ...
            timeInfo: ["The 12/6 from 08:30pm to 10:00pm"],
            prices: ["free access"],
            website: ["", ""],
        },
        {
            ...
            poiId: poi4.id,
            accessInfo: ["done", "block", "done"],
            timeInfo: ["The 26/11 from 9:00am to 04:00pm"],
        ...
        },
        {
            ...
            poiId: poi0.id,
            accessInfo: ["done", "block", "done"],
            timeInfo: ["The 12/6 from 10:00am to 01:00pm"],
            prices: ["free for all"],
